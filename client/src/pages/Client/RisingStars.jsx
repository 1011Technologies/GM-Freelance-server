...
const RisingStars = () => {
    ...
    const filteredProperties = risingStarsArray.filter((property) =>
        ...
        <div className={`md:mx-60 sm:gap-10 gap-5 flex flex-col`}>
            ...
            <div className={`${styles.borderBox} ${styles.padding} w-full sm:gap-10 gap-5 flex flex-col text-center`}>
                <div className="flex flex-col gap-3">
                    <h3 className={`${styles.heading3}`}>Rising Stars</h3>
                    <p className={`${styles.paragraph}`}>We have shortlisted {risingStarsArray.length} rising {risingStarsArray.length >= 1 ? "stars" : "star"} for you</p>
                </div>
