...
const Bookmarks = () => {
    ...
    const filteredProperties = bookmarkedArray.filter((property) =>
        ...
        <div className={`md:mx-60 sm:gap-10 gap-5 flex flex-col`}>
            ...
            <div className={`${styles.borderBox} ${styles.padding} w-full sm:gap-10 gap-5 flex flex-col text-center`}>
                <div className="flex flex-col gap-3">
                    <h3 className={`${styles.heading3}`}>Book Marked</h3>
                    <p className={`${styles.paragraph}`}>You have bookmarked {bookmarkedArray.length} {bookmarkedArray.length >= 1 ? "freelancers" : "freelancer"}</p>
                </div>
