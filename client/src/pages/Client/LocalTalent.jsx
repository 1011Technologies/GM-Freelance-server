...
const LocalTalent = () => {
  ...
  return (
    <div className={`w-full h-full sm:gap-10 gap-5 flex flex-1 flex-col md:flex-row items-start`}>
      <div className={`${styles.padding} block w-full md:sticky md:h-[100vh] top-0 left-0 ${styles.borderBox}`} id="map">
        <img
      ...
      <div className={`${styles.padding} w-full sm:gap-10 gap-5 flex flex-col items-center text-center justify-start ${styles.borderBox} overflow-y-auto`}>
        <h3 className={`${styles.heading3}`}>Freelancers near you, {userInfo.first_name}</h3>
        {propertiesArray.map((properties, index) => (
